...
@pytest.mark.parametrize(
    "input, output, error",
    [
        ("network=public", {"network": "public"}, None),
        (
        ...
        (
            ...
            {
                "network": "9a23808b-dd19-480f-9f55-5a945da4e819",
                "addresses": [{"subnet": "8e79cc58-dc9f-4f68-aeae-e0eac3f06f16"}],
            },
            None,
        ),
        (
            "subnet=91dbef92-ddb1-47e0-8625-73326792d3e1,address=172.26.241.14",
            {
                "addresses": [
                    {
                        "subnet": "91dbef92-ddb1-47e0-8625-73326792d3e1",
        ...
        (
            "network=foo",
            None,
            "Expected UUID or 'public', but found 'foo' at position 8",
        ),
        (
            ...
            "(subnet=91dbef92-ddb1-47e0-8625-73326792d3e1,address=172.26.241.14),(subnet=91dbef92-ddb1-47e0-8625-73326792d3e2,address=172.26.241.15)",
            {
                "addresses": [
                    ...
                    {
                        "subnet": "91dbef92-ddb1-47e0-8625-73326792d3e2",
                        "address": "172.26.241.15",
                    },
                ]
            },
            None,
